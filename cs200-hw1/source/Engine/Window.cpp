...
namespace
{
    [[maybe_unused]] void hint_gl(SDL_GLattr attr, int value)
    {
...
namespace CS230
{
    ...
    // void Window::SetBackgroundColor(Math::vec3 color) noexcept
    // {
    //     CS200::RenderingAPI::SetClearColor(color);
    // }
    ...
    void Window::Update()
    {
        ...
        while (SDL_PollEvent(&event) != 0)
        {
            ...
            {
                case SDL_WINDOWEVENT_CLOSE: is_closed = true; break;
